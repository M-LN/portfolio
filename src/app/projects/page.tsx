...
const allProjects = [
  ...
  },
  {
    ...
    id: '6',
    title: 'Temperature Forecasting Experiments',
    description: 'Experimented with different machine learning approaches to predict temperature patterns. Tried various models like LSTM and XGBoost to see which worked best. Good learning project for understanding time series data and model comparison.',
    technologies: ['Python', 'Machine Learning', 'Time Series', 'Data Experimentation'],
