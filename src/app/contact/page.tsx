  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        {/* Hero Section */}
        <div className="text-center mb-16">          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            Let&apos;s Work Together
          </h1><p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            I&apos;m always interested in new opportunities, challenging projects, and interesting conversations. 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8">
            ...
            </form>            <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div>
            <div className="space-y-8">
              ...
              <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-6">
                ...
                </div>                <p className="text-gray-600 dark:text-gray-300">
